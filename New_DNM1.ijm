...
selectWindow("C2-test");
run("Duplicate...", "title=Dnm1_Binary");
run("Smooth");
run("Smooth");
run("Smooth");
run("Duplicate...", " ");
selectWindow("Dnm1_Binary");
run("Duplicate...", " ");
run("Gaussian Blur...", "sigma=7");
selectWindow("Dnm1_Binary-1");
run("Gaussian Blur...", "sigma=5");
imageCalculator("Subtract create", "Dnm1_Binary-1","Dnm1_Binary-2");
selectWindow("Result of Dnm1_Binary-1");
selectWindow("Dnm1_Binary-1");
close();
selectWindow("Dnm1_Binary-2");
close();
selectWindow("Dnm1_Binary");
close();
selectWindow("Result of Dnm1_Binary-1");
...
selectWindow("Dnm1");
roiManager("Select", j);
run("Duplicate...", "title=Dnm1_"+j+"");
run("Select None");
selectWindow("Dnm1_Binary");
roiManager("Select", j);
run("Duplicate...", "title=Dnm1_Binary_"+j+"");
run("Clear Outside");
run("Select None");
run("Select None");

selectWindow("Dnm1_Binary_"+j+"");
run("Set Measurements...", "area mean standard min perimeter display redirect=Dnm1_"+j+" decimal=3");
